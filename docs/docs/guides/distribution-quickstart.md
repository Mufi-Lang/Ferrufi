...
**For signed builds:** See [Code Signing Guide](./ci-code-signing.md) or jump to [Code Signing](#code-signing) below.
...
**How to get code signing identity:** See [Code Signing](#code-signing) section below or [Code Signing Guide](./ci-code-signing.md).
...
**Full guide:** [Code Signing Guide](./ci-code-signing.md)
...
- **Code Signing:** [Code Signing Guide](./ci-code-signing.md)
- **Distribution:** [Distribution Guide](./distribution.md)
- **All Scripts:** [Scripts README](https://github.com/Mufi-Lang/Ferrufi/blob/main/scripts/README.md)
- **Versioning:** [Versioning Guide](./versioning.md)
