...
public class ThemeManager: ObservableObject {
    ...
    // UserDefaults keys
    private enum Keys {
        static let theme = "iron.selectedTheme"
        static let fontSize = "iron.fontSize"
        static let lineSpacing = "iron.lineSpacing"
        static let cornerRadius = "iron.cornerRadius"
        static let animationSpeed = "iron.animationSpeed"
    }
