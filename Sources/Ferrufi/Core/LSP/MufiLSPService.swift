...
public final class MufiLSPService: ObservableObject {
    ...
    private let mufiStdLib = [
        ...
        "complex", "abs", "phase", "rand", "randn", "pow", "sqrt", "ceil", "floor", "round", "max", "min",
        // io
        ...
        // collections
        "linked_list", "hash_table", "fvec", "push", "pop", "push_front", "pop_front", "len", "get", "set",
        "contains", "clear", "range", "range_to_array", "put", "pairs", "is_empty", "nth", "linspace",
        "insert", "remove", "slice", "merge", "search", "sort", "splice", "sum", "mean", "vari", "stddev",
        "std_alias", "minl", "maxl", "reverse",
        // matrix
        "eye", "ones", "zeros", "transpose", "det", "inv", "trace", "size", "norm", "matrix_get", "matrix_set",
        ...
        "serde_from_toml", "serde_to_yaml", "serde_from_yaml", "serde_detect_format", "serde_validate",
        // filesystem
        "create_file", "write_file", "read_file", "delete_file", "create_dir", "delete_dir", "file_exists",
        "dir_exists", "file_size", "copy_file",
        // time
        "now", "now_ns", "now_ms", "now_us", "sleep", "sleep_ms", "sleep_us", "time_diff",
        // network
        "http_get", "http_post", "http_put", "http_delete", "set_content_type", "set_auth", "parse_url",
        "url_encode", "url_decode", "open_url"
    ].map { MufiCompletionItem(name: $0, typeName: "function", docString: "Standard Library", kind: .function) }
    ...
    private func performAnalysis(filename: String, source: String) {
        Task {
            _ = await bridge.updateSource(filename: filename, source: source)
    ...
    public func triggerCompletions(line: UInt32, column: UInt32, prefix: String = "", anchor: CGRect = .zero) {
        Task {
    ...
    public func moveCompletionSelectionUp() {
        ...
        selectedCompletionIndex = (selectedCompletionIndex - 1 + completionItems.count) % completionItems.count
    }
    ...
    public var selectedCompletion: MufiCompletionItem? {
        guard isCompletionActive && selectedCompletionIndex < completionItems.count else { return nil }
