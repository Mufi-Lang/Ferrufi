...
public final class UpdateManager: ObservableObject {
    ...
    public func checkForUpdates() async -> UpdateCheckResult {
        ...
        let configuredFeed: String? = FerrufiApp.shared?.configuration.additionalSettings["updateFeedURL"]
        let feedURLString = configuredFeed ?? "https://updates.ferrufi.example/latest.json" // placeholder
