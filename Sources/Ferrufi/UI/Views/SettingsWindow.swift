...
/// - Note: This helper lives inside the `Ferrufi` module so it can construct
...
public final class SettingsWindow {
    ...
    func show(tab: SettingsTab = .general) {
        ...
        // If there's no FerrufiApp available yet, don't attempt to show settings.
        // Most callers will run after FerrufiApp.shared has been set.
        ...
        win.setFrameAutosaveName("Ferrufi.settingsWindow")
        if UserDefaults.standard.string(forKey: "Ferrufi.settingsWindow Frame") == nil {
            win.center()
        }
